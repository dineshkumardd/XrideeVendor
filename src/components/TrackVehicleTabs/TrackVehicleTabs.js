...
const TrackVehicleTabs = ({navigation}) => {
  return (
      ...
      <View style={styles.topView}>
        ...
        <View style={styles.topTabView}>
          <Tab.Navigator
            ...
            <Tab.Screen name="Car" component={TrackVehicles} />
            <Tab.Screen name="Bike" component={TrackVehicles} />
            <Tab.Screen name="Auto" component={TrackVehicles} />
            <Tab.Screen name="LC" component={TrackVehicles} />
          </Tab.Navigator>
        </View>
      </View>
    </View>
...
export default TrackVehicleTabs;
