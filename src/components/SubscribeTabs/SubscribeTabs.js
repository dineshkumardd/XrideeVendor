...
const SubscribeTabs = ({navigation}) => {
  return (
      ...
      <View style={styles.topView}>
        <View style={styles.logoView}>
          <View style={styles.logoInnerView}>
            ...
            <Text style={styles.toolbarTxt}>Subscribe</Text>
        ...
        <View style={styles.topTabView}>
          <Tab.Navigator
            ...
            <Tab.Screen name="Car" component={SubscribeList} />
            <Tab.Screen name="Bike" component={SubscribeList} />
            <Tab.Screen name="Auto" component={SubscribeList} />
            <Tab.Screen name="LC" component={SubscribeList} />
          </Tab.Navigator>
        </View>
      </View>
    </View>
