...
import PeriodicPrice from '../PeriodicPrice/PeriodicPrice';
const Tab = createMaterialTopTabNavigator();
const PeriodicPriceTabs = ({navigation}) => {
  return (
      ...
      <View style={styles.topView}>
        ...
        <View style={styles.topTabView}>
          <Tab.Navigator
            ...
            <Tab.Screen name="Car" component={PeriodicPrice} />
            <Tab.Screen name="Bike" component={PeriodicPrice} />
            <Tab.Screen name="Auto" component={PeriodicPrice} />
            <Tab.Screen name="LC" component={PeriodicPrice} />
          </Tab.Navigator>
        </View>
      </View>
    </View>
...
export default PeriodicPriceTabs;
